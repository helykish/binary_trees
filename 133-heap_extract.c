...
/**
 * tree_height - find the height of a binary tree
 * @tree: pointer to the root node of the tree to find the height
 *
...
/**
 * _preorder - move via a binary tree using pre-order traversal
