...
/**
 * create_tree - make an AVL tree with recursion
 *
 * @node: pointer node
 * @array: input array of int
 * @size: length of array
 * @mode: 1 to include on the left, 2 to include on the right
 * Return: no return
 */
...
/**
 * sorted_array_to_avl - make root node and calls to create_tree
 *
